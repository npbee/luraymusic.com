...
<footer class="footer">
    <div class="footer__content">
        ...
        --><section class="footer__right">
            <div class="mailing-list">
                <p class="footer__header">Mailing List</p>
                <form class="input-combo" action="http://luraymusic.us5.list-manage.com/subscribe/post?u=8da68ebf6c5070fcc364c1658&amp;id=64e96e37b2" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <label for="mce-EMAIL"></label>
                    <input type="email" value="" name="EMAIL" class="text-input email" id="mce-EMAIL" placeholder="email address" required><!--
                    --><input type="submit" value="submit" name="subscribe" id="mc-embedded-subscribe" class="button submit">
                </form>
